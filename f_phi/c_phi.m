...
% load data
load('v1-rmoutliers.mat')
load('v2-rmoutliers.mat')
Tv = 400; 
...
if true
    ...
    errorbar(v2stdWFt0/Tv,abs(1-v2PFt0./v2dP),v2PFt0e./v2dP,'o','Color',colmaps{4},'LineWidth',1,'MarkerFaceColor','w'); 
    errorbar(v2stdWFt100/Tv,abs(1-v2PFt100./v2dP),v2PFt100e./v2dP,'s','Color',colmaps{4},'LineWidth',1,'MarkerFaceColor','w'); 
    errorbar(v2stdWRt100/Tv,abs(1-v2PRt100./v2dP),v2PRt100e./v2dP,'s','Color',colmaps{2},'LineWidth',1,'MarkerFaceColor','w'); 
    errorbar(v2stdWRt0/Tv,abs(1-v2PRt0./v2dP),v2PRt0e./v2dP,'o','Color',colmaps{2},'LineWidth',1,'MarkerFaceColor','w'); 
    
    print(gcf,'stdvsphi-rmoutliers.png','-dpng','-r600'); 
    ...
    %axis([8*10^(-1),12,3*10^(-4),10^(-1)])
    %print(gcf,'stdvsphi_logxy.png','-dpng','-r600');    
end


%% (beta*std^2-2*mean)/(2*Delta*Phi) vs delta
...
%     [y_fit,delta] = polyval(p,x,S);
%     patch([x fliplr(x)],[y_fit+2*delta fliplr(y_fit-2*delta)],'black','EdgeColor','none','FaceAlpha',0.1)
    axis([0,0.101,0,0.101])
%     annotation('textbox',[0.51 0.1 0.5 0],'String','Fit: $\delta=0.008\beta\sigma-0.013$','Color',[0,0,0],'Interpreter','Latex','HorizontalAlignment','Center','VerticalAlignment','Bottom','Edgecolor','none','Fontsize',fs);
%     set(gca,'FontSize',fs)
%     plot(x,y_fit,'k','LineWidth',1)
    xlabel('Work histogram parameter $1+(\beta\sigma^2-2\bar{\omega})/(2\Delta\Phi)$') 
    ylabel('Relative error of free energy $\delta$')
    box on
    plot(0:0.001:0.11,0:0.001:0.11)

    % Data plot
    errorbar(1+(v1stdWFt0.^2/Tv-2*v1meanWFt0)./(2*v1dP),abs(1-v1PFt0./v1dP),v1PFt0e./v1dP,'o','Color',colmaps{4},'LineWidth',1,'MarkerFaceColor',colmaps{4}); 
    errorbar(1+(v1stdWFt100.^2/Tv-2*v1meanWFt100)./(2*v1dP),abs(1-v1PFt100./v1dP),v1PFt100e./v1dP,'s','Color',colmaps{4},'LineWidth',1,'MarkerFaceColor',colmaps{4}); 
    errorbar(1-(v1stdWRt100.^2/Tv-2*v1meanWRt100)./(2*v1dP),abs(1-v1PRt100./v1dP),v1PRt100e./v1dP,'s','Color',colmaps{2},'LineWidth',1,'MarkerFaceColor',colmaps{2}); 
    errorbar(1-(v1stdWRt0.^2/Tv-2*v1meanWRt0)./(2*v1dP),abs(1-v1PRt0./v1dP),v1PRt0e./v1dP,'o','Color',colmaps{2},'LineWidth',1,'MarkerFaceColor',colmaps{2}); 
    errorbar(1+(v2stdWFt0.^2/Tv-2*v2meanWFt0)./(2*v2dP),abs(1-v2PFt0./v2dP),v2PFt0e./v2dP,'o','Color',colmaps{4},'LineWidth',1,'MarkerFaceColor','w'); 
    errorbar(1+(v2stdWFt100.^2/Tv-2*v2meanWFt100)./(2*v2dP),abs(1-v2PFt100./v2dP),v2PFt100e./v2dP,'s','Color',colmaps{4},'LineWidth',1,'MarkerFaceColor','w'); 
    errorbar(1-(v2stdWRt100.^2/Tv-2*v2meanWRt100)./(2*v2dP),abs(1-v2PRt100./v2dP),v2PRt100e./v2dP,'s','Color',colmaps{2},'LineWidth',1,'MarkerFaceColor','w'); 
    errorbar(1-(v2stdWRt0.^2/Tv-2*v2meanWRt0)./(2*v2dP),abs(1-v2PRt0./v2dP),v2PRt0e./v2dP,'o','Color',colmaps{2},'LineWidth',1,'MarkerFaceColor','w'); 
    
    print(gcf,'paravsdelta-rmoutliers.png','-dpng','-r600');  
end
...
if true
    ...
    errorbar(v1lam+v1sep*1.5,v1PFt0./v1dP,v1PFt0e./v1dP,'o','Color',colmaps{4},'LineWidth',1,'MarkerFaceColor',colmaps{4}); 
    errorbar(v1lam+v1sep*0.5,v1PFt100./v1dP,v1PFt100e./v1dP,'s','Color',colmaps{4},'LineWidth',1,'MarkerFaceColor',colmaps{4}); 
    errorbar(v1lam-v1sep*0.5,v1PRt100./v1dP,v1PRt100e./v1dP,'s','Color',colmaps{2},'LineWidth',1,'MarkerFaceColor',colmaps{2}); 
    errorbar(v1lam-v1sep*1.5,v1PRt0./v1dP,v1PRt0e./v1dP,'o','Color',colmaps{2},'LineWidth',1,'MarkerFaceColor',colmaps{2}); 
    ...
    print(gcf,'lamvsphistdv1-rmoutliers.png','-dpng','-r600');
end
...
if true
    ...
    errorbar(v2lam+v2sep*1.5,v2PFt0./v2dP,v2PFt0e./v2dP,'o','Color',colmaps{4},'LineWidth',1,'MarkerFaceColor','w'); 
    errorbar(v2lam+v2sep*0.5,v2PFt100./v2dP,v2PFt100e./v2dP,'s','Color',colmaps{4},'LineWidth',1,'MarkerFaceColor','w'); 
    errorbar(v2lam-v2sep*0.5,v2PRt100./v2dP,v2PRt100e./v2dP,'s','Color',colmaps{2},'LineWidth',1,'MarkerFaceColor','w'); 
    errorbar(v2lam-v2sep*1.5,v2PRt0./v2dP,v2PRt0e./v2dP,'o','Color',colmaps{2},'LineWidth',1,'MarkerFaceColor','w'); 
    ylabel('$\Delta\Phi_{F/R}/\Delta\Phi$')  
    ...
    plot(v2lam+v2sep*1.5,v2stdWFt0/Tv,'o','Color',colmaps{4},'LineWidth',1,'MarkerFaceColor','w'); 
    plot(v2lam+v2sep*0.5,v2stdWFt100/Tv,'s','Color',colmaps{4},'LineWidth',1,'MarkerFaceColor','w'); 
    plot(v2lam-v2sep*0.5,v2stdWRt100/Tv,'s','Color',colmaps{2},'LineWidth',1,'MarkerFaceColor','w'); 
    plot(v2lam-v2sep*1.5,v2stdWRt0/Tv,'o','Color',colmaps{2},'LineWidth',1,'MarkerFaceColor','w'); 
    ...
    print(gcf,'lamvsphistdv2-rmoutliers.png','-dpng','-r600');
end